      ...
      >
        <DrawerPrimitive.Popup
          ...
          className={cn(
            ...
            // Sizing.
            "[--drawer-content-height:var(--drawer-height,auto)] data-[swipe-axis=x]:[--drawer-content-width:92%] data-[swipe-axis=y]:[--drawer-content-max-height:calc(100dvh-2rem)] data-[swipe-axis=y]:data-snap-points:[--drawer-content-height:100dvh] data-[swipe-axis=x]:sm:[--drawer-content-width:min(30rem,92vw)]",
            // Stack.
