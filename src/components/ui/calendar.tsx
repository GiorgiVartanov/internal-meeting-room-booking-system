...
import { CalendarChevron } from "@/components/ui/calendar-chevron"
import { CalendarDayButton } from "@/components/ui/calendar-day-button"
import { CalendarRoot } from "@/components/ui/calendar-root"
import { CalendarWeekNumber } from "@/components/ui/calendar-week-number"
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: cn(
          "w-40 justify-center text-center font-medium select-none",
          captionLayout === "label"
            ? "text-sm"
